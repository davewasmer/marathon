...
# Figure out the TLD for the resolver file
# basically a quick & dirty regex on the config.json file
# don't look - bash is not my strong suit :/
...
# All done!
    ...
    echo ""
    echo "Note: I left your projects directory untouched."
